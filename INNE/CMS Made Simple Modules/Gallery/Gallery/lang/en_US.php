...
$lang['tinymce_description_picker'] = 'Pick a photo gallery to display';
$lang['tinymce_button_picker'] = 'Insert Gallery';
...
$lang['moveto'] = 'Move To';
$lang['imageupdated'] = 'The image is updated.';
$lang['imagedetailsupdated'] = 'The image details are updated.';
...
$lang['jsposition'] = 'Where to insert the javascript';
$lang['jstop'] = 'in the &#8249;head&#8250; element';
$lang['jsbtm'] = 'at the bottom of the &#8249;body&#8250; element';
...
<code>{$images}</code> - array with keys:<br />
 - <code>file</code> - url to the original image (or subgallery)<br />
 ...
 - <code>thumb</code> - url to the thumbnail. In case of a subgallery, this wil revert to the image which is set as default in that subgallery. If no image is set as default, a standard folder-icon will be used.<br />
...
$lang['rotateanticlockwise'] = 'Rotate anticlockwise';
$lang['editthumb_help'] = 'Click and drag on the image to select an area';
$lang['thumb_current'] = 'Current Thumb';
$lang['thumb_preview'] = 'Thumb Preview';
...
';
$lang['help_loadcustomfields'] = 'Only to use with action=\'gallerytree\'. Set this parameter to 1 if you want to use custom fields in your gallerytree template.';
...
<p>If you want to create your own template and be able to export it, be shure to put any needed files (besides the default available ones) in its own folder with the template name in <em>assets/modules/Gallery/templates/</em>. Those files will be included in the xml exportfile automatically. Click on the about link to edit the version number and the about text.</p>
...
<p>By default the Search module will return links to subgalleries that contain matching words in either the subgallery fields or the image fields.</p>
<p>To change that behaviour, check the setting \'Search individual images in stead of subgalleries\' in the Options tab.</p>
<p>With a little Smarty logic you can even show the images themselves in the search result, in stead of only links. Just edit the \'Result Template\' in the Search module admin section.</p>
<p>E.g change:</p><pre>&lt;li&gt;{$entry->title} - &lt;a href="{$entry->url}"&gt;{$entry->urltxt}&lt;/a&gt; ({$entry->weight}%)&lt;/li&gt;</pre>
<p>to:</p><pre>&lt;li&gt;{if $entry->title == \'Gallery image\'}{Gallery img=$entry->modulerecord}{else}
